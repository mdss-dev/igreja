...
<head>
  ...
  <link href="sistema/img/Logo_Ico-4.ico" rel="shortcut icon" type="image/x-icon">
      ...
      <div class="row align-items-center">
        <div class="col-auto">
          ...
          <span class="text-uppercase">
            <p class="navbar-text text-primary ml-10 font-weight-bold" style="overflow: visible;"><?php echo $nome_igreja_sistema ?></p>
          </span>
        </div>
        ...
        <div class="col-lg-auto navbar-collapse main-menu-collapse mr-auto position-inherit collapse" style="">
          <ul class="navbar-nav" style="">
            ...
            <li class="nav-item">
              <a class="nav-link sub-menu-link" href="#" style=""><strong><span class="text-uppercase">Congregacões</span><svg xmlns="http://www.w3.org/2000/svg" height="16" viewBox="0 0 16 16" width="16" class="icon icon-pos-right svg-secondary">
        ...
        <div class="col-auto navbar-collapse main-menu-collapse collapse" style="">
          <div class="d-inline-block inline-group">
            ...
            <a target="_blank" href="<?php echo @$facebook ?>"><svg xmlns="http://www.w3.org/2000/svg" height="16" viewBox="0 0 16 16" width="16" class="icon svg-default">
            ...
            <a target="_blank" href="<?php echo @$instagram ?>"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" height="16" viewBox="0 0 16 16" width="16" class="icon svg-default">
              ...
              <div class="row">
                <div class="col" style="">
                  ...
                  <div style="display:<?php echo $ocultar_titulo ?>">
                    <h2 class="mt-sm-75"><strong style="color:#383838"><?php echo $titulo ?></strong></h2>
                    <h4 class="mt-sm-75" style="color:#383838"><strong class="">Congregação <?php echo $nome_ig ?></strong></h4>
                  </div>
                  ...
                  <a href="evento-<?php echo $url ?>" class="btn btn-light btn-lg fx-btn-pill" style=""><strong>Detalhes</strong><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 448 512" class="icon icon-pos-right" srcset="">
          ...
          <div class="carousel-3item pb-50 owl-drag">
            ...
            ?>
                ...
                <div class="item gallery-item rounded gallery-style-1 border-x2 padding"><a href="index2.html" target="_self" class="smooth">
                  ...
                  <div class="item-title" style=""><a href="index2.html" target="_self" class="smooth">

                      <h4 class="text-center" style=""><b class=""><?php echo $nome ?></b></h4>
                      <p class="small text-center mb-sm-10" style=""><?php echo $endereco ?></p>
                    </a><a class="btn mb-md-0 text-center btn-sm btn-block smooth btn-outline-dark fx-btn-pill mt-30" href="igreja<?php echo $url ?>" style="" target="_self">Visitar Site<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 448 512" class="icon icon-pos-right" srcset="">
                        <path d="M190.5 66.9l22.2-22.2c9.4-9.4 24.6-9.4 33.9 0L441 239c9.4 9.4 9.4 24.6 0 33.9L246.6 467.3c-9.4 9.4-24.6 9.4-33.9 0l-22.2-22.2c-9.5-9.5-9.3-25 .4-34.3L311.4 296H24c-13.3 0-24-10.7-24-24v-32c0-13.3 10.7-24 24-24h287.4L190.9 101.2c-9.8-9.3-10-24.8-.4-34.3z"></path>
                      </svg></a></div>
                  <div class="item-icon">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-12 ml-auto mr-auto" style="">
            <h2 class="text-center mb-10 mt--30 mt-sm-0" style="">Eventos Gerais</h2>
            <p style="" class="mb-50 text-center">Últimos eventos de nossas Congregações!<br></p>
            <div class="carousel-3item pb-50 owl-drag">
                ...
                <div class="item gallery-item dark padding-x2 gallery-style-1">
                  ...
                  <div class="item-icon">
                    <ul class="list-inline small text-right">
                      <li class=""><svg xmlns="http://www.w3.org/2000/svg" height="16px" viewBox="0 0 448 512" width="16" class="icon svg-default icon-pos-left" srcset="">
                          <path d="m436 160h-424c-6.6 0-12-5.4-12-12v-36c0-26.5 21.5-48 48-48h48v-52c0-6.6 5.4-12 12-12h40c6.6 0 12 5.4 12 12v52h128v-52c0-6.6 5.4-12 12-12h40c6.6 0 12 5.4 12 12v52h48c26.5 0 48 21.5 48 48v36c0 6.6-5.4 12-12 12zm-424 32h424c6.6 0 12 5.4 12 12v260c0 26.5-21.5 48-48 48h-352c-26.5 0-48-21.5-48-48v-260c0-6.6 5.4-12 12-12zm116 204c0-6.6-5.4-12-12-12h-40c-6.6 0-12 5.4-12 12v40c0 6.6 5.4 12 12 12h40c6.6 0 12-5.4 12-12zm0-128c0-6.6-5.4-12-12-12h-40c-6.6 0-12 5.4-12 12v40c0 6.6 5.4 12 12 12h40c6.6 0 12-5.4 12-12zm128 128c0-6.6-5.4-12-12-12h-40c-6.6 0-12 5.4-12 12v40c0 6.6 5.4 12 12 12h40c6.6 0 12-5.4 12-12zm0-128c0-6.6-5.4-12-12-12h-40c-6.6 0-12 5.4-12 12v40c0 6.6 5.4 12 12 12h40c6.6 0 12-5.4 12-12zm128 128c0-6.6-5.4-12-12-12h-40c-6.6 0-12 5.4-12 12v40c0 6.6 5.4 12 12 12h40c6.6 0 12-5.4 12-12zm0-128c0-6.6-5.4-12-12-12h-40c-6.6 0-12 5.4-12 12v40c0 6.6 5.4 12 12 12h40c6.6 0 12-5.4 12-12z" class=""></path>
                        </svg><a href="#" class=""><b class="">&nbsp;<?php echo $data_eventoF ?></b><br></a></li>
                    </ul>
                    <ul class="list-inline text-center lead text-primary">
                      <li class="" style=""><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16px" viewBox="0 0 512 512" class="icon svg-default icon-pos-left" srcset="">
                          <path d="M504 256C504 119 393 8 256 8S8 119 8 256s111 248 248 248 248-111 248-248zm-448 0c0-110.5 89.5-200 200-200s200 89.5 200 200-89.5 200-200 200S56 366.5 56 256zm72 20v-40c0-6.6 5.4-12 12-12h116v-67c0-10.7 12.9-16 20.5-8.5l99 99c4.7 4.7 4.7 12.3 0 17l-99 99c-7.6 7.6-20.5 2.2-20.5-8.5v-67H140c-6.6 0-12-5.4-12-12z"></path>
                        </svg><a href="evento-<?php echo $url ?>" class="" style=""><b class="">Ver Evento</b><br></a></li>
                    </ul>
                  </div>
                </div>
...
<script defer src='//s3.sa-east-1.amazonaws.com/cdn.webeditor.link/builder10/v01/lib.min.js'></script>
<script defer src='//s3.sa-east-1.amazonaws.com/cdn.webeditor.link/builder10/v01/lib.subscribers.min.js'></script>
<script defer src='//s3.sa-east-1.amazonaws.com/cdn.webeditor.link/builder10/v01/lib.lazyload.min.js'></script>
